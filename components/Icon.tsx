 ...
 * ici la rend disponible partout via <Icon name="..." />.
 */
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  linkedin: (
    <>
      ...
      <path d="M11 20v-7a3 3 0 0 1 6 0v7M11 9v11" />
    </>
  ),
  whatsapp: (
    <>
      <path d="M4 20l1.3-4.2A8 8 0 1 1 8.4 19z" />
      <path d="M9 9.5c.3 2.6 2.9 5.2 5.5 5.5.6.1 1.5-.9 1-1.4l-1.7-1.1-1 .8c-.8-.4-1.7-1.3-2.1-2.1l.8-1-1.1-1.7c-.5-.5-1.5.4-1.4 1z" />
    </>
  ),
};
